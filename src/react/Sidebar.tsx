...
export default function Sidebar() {
	...
	return (
		<aside
			...
			className={`transition-all duration-200 bg-gray-100 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 hidden md:flex flex-col ${expanded ? "w-64" : "w-20"}`}
		>
							...
							<span className="flex items-center justify-center h-8 w-8 relative">
								...
								>
									<button
										...
										className="flex items-center justify-center h-8 w-8 p-0 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-transparent z-10"
										aria-label={
